...
Pentru inceput cateva link-uri utile:
 ...
 - [Run **LLM** on Pi5: Connecting an NVIDIA GPU(eGPU) to Raspberry Pi 5 via PCIe x4](https://alican-kiraz1.medium.com/run-llm-on-pi5-connecting-an-nvidia-gpu-to-raspberry-pi-5-via-pcie-x4-a6d52c3efd2a)
