...
Directia pentru Politici Fiscale si Bugetare Locale [**DPFBL/MDRAP**](http://www.dpfbl.mdrap.ro/) a pus la dispozitie un xcel cu codurile [***SIRUTA***](http://www.dpfbl.mdrap.ro/documents/machete_cu_cod_siruta_si_uat_pe_judete.xls) defalcate pe judete(utile in cazul in care doriti sa incarcati un judet sau mai multe judete dar nu toata tara) si integral pentru toata tara.
