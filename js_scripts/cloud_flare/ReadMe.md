...
Referitor la programarea in ***Python*** - acest [tutorial](https://blog.cloudflare.com/python-workers) pentru un **worker** scris in **python**, poate fi un elocvent exemplu in privinta
deschiderii CF si catre alte limbaje populare(in afara de JS<sup>nodeJS</sup>)
