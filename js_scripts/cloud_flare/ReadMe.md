...
- [**Arhitecturi**](https://developers.cloudflare.com/reference-architecture/architectures/):
  ...
  - [***LB***](https://developers.cloudflare.com/reference-architecture/architectures/load-balancing/) - [echilibratoare](https://www.loadbalancer.org/blog/load-balancing-methods/)/[balansoare](https://www.mdpi.com/1424-8220/20/24/7342) de sarcina/incarcare(eng.load) - a se vedea si acesti [6 algoritmi-LB](https://www.youtube.com/watch?v=yjD136piimk&ab_channel=Cloudflare);
