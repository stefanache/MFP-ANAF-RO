...
Cu toate acestea, referitor la programarea in ***Python*** - acest [tutorial](https://blog.cloudflare.com/python-workers) pentru un **worker** scris in **python**, poate fi totusi un elocvent exemplu in privinta
