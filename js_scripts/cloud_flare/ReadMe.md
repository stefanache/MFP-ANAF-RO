...
Cu alte cuvinte, probabil ca exista/veti gasi **solutii de a interactiona**/[**lega**](https://blog.cloudflare.com/cloudflare-php-api-binding)(SDK-uri, librarii, binders, wrappers...) din codul [PhP](https://github.com/cloudflare/cloudflare-php), [Python](https://blog.cloudflare.com/python-cloudflare), Java,Go....**cu** cloud-ul **CF** dar **rularea** acestora **nu** este nativa-**CF**, **ci** va trebui sa se desfasoare in mediul **extern** al CF-cloud-ului;<br/>Unele dintre aceste solutii, ar putea sa **traduca/translateze/transforme/injecteze** codul respectiv(PhP,...) in/ca si cod static(**JS**<sup>**nodeJS***</sup>) ***acceptat*** de catre cloud-ul **CF** in faza viitoare de **rulare/executie**(chiar daca vor trebui sa existe probabil si anumite restrictii!!!). <br/>
