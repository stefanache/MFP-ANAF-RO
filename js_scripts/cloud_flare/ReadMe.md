...
Despre oferta de preturi in ceea ce priveste partea asta de "**workers**" puteti citi acest [material](https://www.cloudflare.com/plans/developer-platform-pricing/); In general despre planurile **free** puteti accesa acest [**link**](https://www.cloudflare.com/plans/free/); O comparatie a planurilor de pret o puteti accesa [*aici*](https://www.cloudflare.com/plans/); Puteti constata ca este o oferta destul de generoasa pentru zona de gratuitate dar luati in calcul si momentul viitor(ce vine odata cu scalarea aplicatiei si cresterea traficului acesteia) cand veti avea nevoie si de celelate planuri.  
