...
- [***Modele arhitecturale***(si... cele mai bune practici)](https://developers.cloudflare.com/reference-architecture/diagrams/):
  ...
  Tot aici merita a se vedea acest tutorial de ["**Constructie AI pt RAG**"](https://developers.cloudflare.com/workers-ai/tutorials/build-a-retrieval-augmented-generation-ai/); Veți construi o aplicație completă bazată pe inteligență artificială, folosind/legata la instrumente precum [Workers AI](https://developers.cloudflare.com/workers-ai/), [Vectorize](https://developers.cloudflare.com/vectorize/), [D1](https://developers.cloudflare.com/d1/) și Cloudflare [Workers](https://blog.cloudflare.com/introducing-cloudflare-workers).
