...
In final, daca ne referim la PhP, probabil ca ar fi, de retinut,  urmatoarele:<br/>
 ...
 - referitor la programarea in Python - acest tutorial pentru un **worker** scris in **python** poate fi un elocvent exemplu in privinta
   deschiderii CF si catre alte limbaje populare(in afara JS<sup>nodeJS</sup>-ului)
