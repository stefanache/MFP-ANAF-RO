...
<hr/>
   ...
   (*deci, bidirectional*) mesaje(cu livrare garantată pentru lățimea de bandă de ieșire și fără taxe)<br/>
     ...
     Pe parcurs ce reusiti sa va (-/scu-)-fundati tot mai mult in acest demers al intelegerii acestui concept, al **cozilor de mesaje Cloudflare**(ori in cele din urma), dobandind experienta in lucurl cu aceasta entitate-CF,  probabil veti dori, sa accesati si pagina de PoC / [***Referinta***](https://developers.cloudflare.com/queues/reference/) a acestora.
