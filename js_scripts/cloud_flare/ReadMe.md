...
In final, daca ne referim la PhP, probabil ca ar fi, de retinut,  urmatoarele:<br/>
 ...
 - vom putea deci folosi/accesa [resursele-CF](https://developers.cloudflare.com/workers/runtime-apis/) din cadrul PhP ori la alt nivel(extern...spre ex. la nivel de webserver,DNS,CDN....) dar CF-ul nu va rula(cel putin deocamdata), nativ, cod PhP
