...
In final daca aveti un "hosting" **PhP/MySQL**, cumparat sau auto-gazduit,  pe care doriti sa-l pastrati, atunci puteti utiliza **CF** pentru a imbunatati [**performanta** si **securitatea**](https://webmasters.stackexchange.com/questions/61068/how-can-cloudlfare-speed-up-php-mysql) acestuia(astfel lucrand in **tandem**, probabil veti/puteti obtine rezultatele scontate)
