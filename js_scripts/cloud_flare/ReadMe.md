...
In final, daca ne referim la PhP, probabil ca ar fi, de retinut,  urmatoarele:<br/>
 ...
 - vom putea deci folosi/accesa resursele-CF din cadrul PhP ori la alt nivel(extern...spre ex. la nivel de webserver,DNS,CDN....) dar CF-ul nu va rula(cel putin deocamdata), nativ, cod PhP
   (de pilda ati putea plasa [metadatele](https://www.linkedin.com/pulse/streamlining-php-package-distribution-cloudflares-platform-goller-htiyf/) in CDN-ul CF si apoi utiliza cu **Composer** atunci cand veti distribui pachete in diverse proiecte-PhP).
