...
- [**Free4Dev**](https://free-for.dev) ofera o multime de liste de SW( (SaaS, PaaS, IaaS, etc.) și alte oferte(cu niveluri gratuite pentru dezvoltatori):
   ...
   <sup>( dupa ce in prealabil ati urmat instructiunile de instalare ***NodeJS*** incluzand ***npm*** si ***daemonul*** oferit de catre **Cloudflared** "***cloudflared***",  pentru versiunea sistemului de operare pe care-l detineti )</sup>; dupa instalare veti obtine un link de forma:<br/>
