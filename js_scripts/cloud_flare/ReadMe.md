...
- [**Arhitecturi**](https://developers.cloudflare.com/reference-architecture/architectures/):
  ...
  - [***LB***](https://developers.cloudflare.com/reference-architecture/architectures/load-balancing/) - echilibratoare/balansoare de sarcina/incarcare(eng.load) - a se vedea si acesti [6 algoritmi-LB](https://www.youtube.com/watch?v=yjD136piimk&ab_channel=Cloudflare);
