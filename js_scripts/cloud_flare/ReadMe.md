...
**--OBS--**: 
    ...
    - mai intai de toate, trebuie mentionat si faptul ca, pentru verificarea de la distanta a functionarii codului/worker-ului, <br/>
    exista si puteti utiliza si alte metode(ex. **curl**: <br/>
