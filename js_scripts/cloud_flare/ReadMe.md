...
Cu alte cuvinte, probabil ca exista/veti gasi **solutii de a interactiona** din codul PhP,Java,Go....cu cloud-ul **CF** dar **rularea** acestora **nu** este nativa-**CF**, **ci** va trebui sa se desfasoare in mediul **extern** al cloud-ului;<br/> 
