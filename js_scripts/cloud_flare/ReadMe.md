...
De altfel, legat de acest subiect al workers/lucratorilor si [nu numai](https://www.cloudflare.com/plans/developer-platform/), CF a oferit comunitatii [dezvoltatorilor](https://developers.cloudflare.com/), o multime de [exemple](https://developers.cloudflare.com/workers/examples/) si [tutoriale](https://developers.cloudflare.com/workers/tutorials/). Pentru o buna [documentare](https://developers.cloudflare.com/tutorials/#f:@product=[Pages]) puteti consulta acest [**link**](https://www.cloudflare.com/plans/developer-platform/)<sup>optiunea de meniu: ***RESURSE***</sup>; Iata de [pilda](https://developers.cloudflare.com/tutorials/#f:@product=[PubSub]) un exemplu [**PubSub**](https://developers.cloudflare.com/pub-sub/guide/); Oricum sunt o multime de [cai de invatare](https://developers.cloudflare.com/learning-paths/) si de [tutoriale](https://developers.cloudflare.com/tutorials/);
