...
**Nota**: **Wrangler** *necesită o versiune* ***NodeJS*** *16.17.0+* <sup>(sau o versiune ulterioară)</sup><sup>( a se vedea [*instalarea*](https://developers.cloudflare.com/workers/wrangler/install-and-update/)</sup> **wrangler**-ului !!!)
