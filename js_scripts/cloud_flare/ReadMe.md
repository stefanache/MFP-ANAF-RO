...
Pentru cei mai grabiti dintre voi de a afla lucruri noi, CF a pus la dispozitia dezvoltatorilor(poate mai experimentati) bine-cunoscuta sectiune [**QuickStarts**](https://developers.cloudflare.com/workers/get-started/quickstarts/); Sunt prezente comenzile **npx** ***wrangle** de incarcare ale exemplelor dar si link-ul aferent catre depozitul sau [ghithub](https://github.com/cloudflare/workers-sdk/tree/main/templates/worker-router)
