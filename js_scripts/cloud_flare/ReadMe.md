...
<hr/>
   ...
   (*deci, bidirectional*) mesaje(cu livrare garantată pentru lățimea de bandă de ieșire și fără taxe)<br/>
     ...
     Printre subiectele interesante de analizat, legate de subictul cozilor de mesaje/scrisori, as  putea enumera [**DLQ**](https://developers.cloudflare.com/queues/reference/dead-letter-queues/). [**Pull consumers**](https://developers.cloudflare.com/queues/reference/pull-consumers/), <br/>
