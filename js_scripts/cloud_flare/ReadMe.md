...
Este posibil ca pentru cei mai multi programatori, ecosistemul din jurul***Javascript**(***nodeJS***) sa fie suficient.<br/>
...
In final, concluzia referitoare la PhP, ar fi, prin urmare urmatoarea:<br/>daca aveti un "hosting" **PhP/MySQL**, cumparat,auto-gazduit sau rezident in cloud,  pe care doriti sa-l pastrati, atunci puteti utiliza **CF** pentru a imbunatati [**performanta** si **securitatea**](https://webmasters.stackexchange.com/questions/61068/how-can-cloudlfare-speed-up-php-mysql) acestuia(astfel lucrand in **tandem**, probabil veti/puteti obtine rezultatele scontate).<br/>
