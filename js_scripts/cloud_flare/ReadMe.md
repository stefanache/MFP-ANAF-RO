...
Cu alte cuvinte, probabil ca exista/veti gasi **solutii de a interactiona**(SDK-uri, librarii, wrappers...) din codul [PhP](https://github.com/cloudflare/cloudflare-php), [Python](https://blog.cloudflare.com/python-cloudflare), Java,Go....**cu** cloud-ul **CF** dar **rularea** acestora **nu** este nativa-**CF**, **ci** va trebui sa se desfasoare in mediul **extern** al CF-cloud-ului;<br/>Unele dintre aceste solutii, ar putea sa **traduca/translateze/transforme** codul respectiv(PhP,...) in cod static(**JS**<sup>**nodeJS***</sup>) ***acceptat*** de catre cloud-ul **CF** in faza de/la **rulare/executie**(chiar daca vor trebui sa existe probabil si anumite restrictii!!!). <br/>
