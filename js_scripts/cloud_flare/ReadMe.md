...
<hr/>
   ...
   (*deci, bidirectional*) mesaje(cu livrare garantată pentru lățimea de bandă de ieșire și fără taxe)<br/>
     ...
     Spre deosebire de un API tradițional, API-ul GraphQL  are un singur punct final(endpoint](https://api.cloudflare.com/client/v4/graphql): ***https://api.cloudflare.com/client/v4/graphql***
