...
<br/>Noutatea consta in faptul ca nu trebuie sa va preocupe implementarea si/sau folosirea unui server anume sau anumite operatii neintuitive precum serializarea datelor in vederea transportului, operatiuni care sunt ascunse utilizatorului/dezvoltatorului, care in mare masura este preocupat doar de utilizarea/fructificarea acestui mecanism(ascuns), permitandu-i acestuia sa se poata concentra mai mult asupra aplicatiei/proiectului sale/sau pe care doreste sa-l finalizeze/proiecteze/dezvolte.
