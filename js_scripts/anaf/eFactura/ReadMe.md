...
Daca doriti sa programati in **PhP** utilizarea webservice-ului oficial al ANAF de transforamre **xml to pdf** poate ar fi util sa consultati si acest [***articol happyweb***](https://happyweb.ro/articol/eroare-la-transformare-e-factura-din-xml-in-pdf);
...
Despre conturile bancare(**BT-84**) ale [**e-Facturii**](https://www.slideshare.net/geomexicanu1980/prezentare-api-efactura-1pdf) puteti vizualiza acesta pagina a site-ului [**ro-efactura**](https://ro-efactura.ro/tag/xml-efactura/)
...
Am testat si eu acest [***cod PhP***](https://www.grepper.com/answers/465839/api+anaf) care face [verificarea unui agent economic platitor de TVA](https://www.verificaretva.ro/download/DocumentatieVerificareTVAAPIv5.pdf);
Codul meu de testare fisier **index.php** l-am plasat intr-un subdirector director al serverului apache(in subdirectorul ***htdocs***) controlat de **XAMPP** denumit  ***api_anaf*** si are urmatorul continut:
