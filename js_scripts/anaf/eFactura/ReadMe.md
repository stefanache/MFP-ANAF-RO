...
Codurile [**NC**](https://sb-img1.s3.eu-central-1.amazonaws.com/ajutorsmartbill/CN_2022_utilizat_in_smartbill.xlsx) si [**CPV**](https://sb-img1.s3.eu-central-1.amazonaws.com/ajutorsmartbill/Coduri+CPV+-++REGULAMENTUL+(CE)+NR.2132008+AL+COMISIEI.pdf) sunt obligatorii doar pentru [***produsele cu risc fiscal ridicat***](https://ajutor.smartbill.ro/article/987-produsele-cu-risc-fiscal-ridicat), dar pot fi adaugate si pentru **oricare produs**.
Aceste coduri adaugate atunci cand completati eFactura trebuie sa fie preluate din [BD/site-uri  oficiale](https://www.123coduri.ro/cauta-in-baza-de-date-coduri-cpv.php);
