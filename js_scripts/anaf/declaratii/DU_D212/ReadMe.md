...
Tot ce am discutat aici despre afisarea fisierului XSD folosind XSL se poate aplica si in cazul oricarui fisier XSD(astfel ca  rezultatul acesta il putem folosi/utiliza pentru toate formularele ANAF care au fisier de/pt validare [*.xsd](https://www.w3schools.com/xml/schema_facets.asp) asociat).
