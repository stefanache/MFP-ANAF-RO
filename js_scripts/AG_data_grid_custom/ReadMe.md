...
- [plnkr.co-embed-plunk: Angular example](https://embed.plnkr.co/plunk/wh6ZMS8id1lhMDeK)
  <br/>***Remarca***: AG-grid se poate folosi in combinatie cu alte librarii bine-cunoscute([Angular](https://embed.plnkr.co/plunk/wh6ZMS8id1lhMDeK),[React](https://blog.ag-grid.com/whats-new-in-ag-grid-26/),[Vue](https://www.jsdelivr.com/package/npm/@ag-grid-community/vue)...) sau poate fi chiar/pur-si-simplu inlocuit!
