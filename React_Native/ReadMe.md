...
<details>
 <summary>...hai sa vorbim( mai in detaliu...!) despre <ins>hook/carlig</ins>-ul utilizat la etapa/stagiul de validare, in constructia(<i>setUp</i>-ul) unui nou proiect-<b>RN</b>, folosind <i>template</i>/sablon/format-ul-<i>starter</i>, oferit de catre cei de la <b><i>oByte</i></b>...</summary>
 <hr/>
...
<br/>[***Husky***](https://typicode.github.io/husky/)-folosit pt Git-Hooks; [***Prettier***](https://prettier.io/docs/precommit); [***ESlint***](https://eslint.org/docs/latest/use/getting-started); [*deps/dependencies*](https://www.dependencies.io/);
