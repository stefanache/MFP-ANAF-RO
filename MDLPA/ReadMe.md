...
Am un ***GPU*** **Nvidia RTX 4060 8GB VRAM** pe care  am instalat [**Ollama**](https://www.thomas-krenn.com/en/wiki/Installation_of_Ollama) pe **Ubuntu 24.04 LTS**:
...
Vor fi afisare **locurile**/plotii(**extrudate 3D**, in mod artificial pt a le face vizibile in **3D**) cf cu imaginea originala([***qcad*/Screenshot_20260731_092127_com_dropbox_android_PreviewActivity.jpg**]()).
