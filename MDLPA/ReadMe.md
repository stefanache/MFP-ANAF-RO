...
Pt acest convertor(***JPG*** 2 **IFC** sau ***JPG*** @ **IFC** ori ***JPG*** to **IFC**), am folosit DeskTop-PC dotat cu un ***GPU*** **Nvidia RTX 4060 8GB VRAM** pe care  am instalat [**Ollama**](https://www.thomas-krenn.com/en/wiki/Installation_of_Ollama) pe **Ubuntu 24.04 LTS**:
