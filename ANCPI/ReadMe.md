...
[QTempo](https://github.com/alecsandrei/QTempo): A [**QGIS**](https://qgis.org/ro/) [plugin](https://plugins.qgis.org/plugins/qtempo/) that integrates statistical-data(INSSE - date statistice transmise de agentiile-guvernamentale) with administrative-boundaries(ANCPI - limite administrativ-teritoriale) sourced via **ANCPI *ArcGIS* MapServices** and **GISCO APIs**.
