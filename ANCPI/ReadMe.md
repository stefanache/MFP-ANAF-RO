...
[OSGeo4W](https://www.osgeo.org/projects/osgeo4w/) kit which includes open source GIS-desktop applications([QGIS](https://www.osgeo.org/projects/qgis), GRASS GIS), geospatial libraries(PROJ, GDAL/OGR, GEOS, SpatiaLite, SAGA GIS), scripting-languages(Python) as well as many other geospatial related packages.
