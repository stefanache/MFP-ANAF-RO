...
[OSGeo4W](https://www.osgeo.org/projects/osgeo4w/) lit which includes open source GIS-desktop applications(QGIS, GRASS GIS), geospatial libraries(PROJ, GDAL/OGR, GEOS, SpatiaLite, SAGA GIS), scripting-languages(Python) as well as many other geospatial related packages.
