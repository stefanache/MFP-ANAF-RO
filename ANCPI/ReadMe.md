...
[QTempo](https://github.com/alecsandrei/QTempo): A [**QGIS**](https://qgis.org/ro/) plugin that integrates statistical-data(INSSE) with administrative-boundaries(ANCPI) sourced via **ANCPI *ArcGIS* MapServices** and **GISCO APIs**.
