...
[QTempo](https://github.com/alecsandrei/QTempo): A [**QGIS**](https://qgis.org/ro/) [plugin](https://plugins.qgis.org/plugins/qtempo/) that integrates statistical-data(INSSE - date statistice transmise de agentiile-guvernamentale) with administrative-boundaries(ANCPI - limite administrativ-teritoriale) sourced via [**ANCPI *ArcGIS* MapServices**](https://www.google.com/search?q=ANCPI+ArcGIS+MapServices&oq=ANCPI+ArcGIS+MapServices&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIJCAEQIRgKGKABMgkIAhAhGAoYoAEyBwgDECEYjwLSAQkzODMxajBqMTWoAgiwAgHxBZqcqDmn3wU_8QWanKg5p98FPw&sourceid=chrome&ie=UTF-8) and **GISCO APIs**.
