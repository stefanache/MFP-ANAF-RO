...
Orice fel de sprijin in acest sens este binevenit dar trebuie a fiti atenti si la [versiunea](https://static.anaf.ro/static/10/Anaf/Declaratii_R/S1001/Ghid-v2.pdf) acestor publicatii acolo unde aceasta va este la indemana sau macar sa va uitati la data publicarii acestor articole(desigur important ramane si autorul acestora) deoarece acest context(legat de declaratii) este in continua schimbare si este posibil ca anumite informatii sa se fi depreciat.
