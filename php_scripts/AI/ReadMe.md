...
Aici o sa postez cateva [link](https://stackoverflow.com/questions/33080068/running-composer-in-a-different-directory-than-current)-uri legate de [AI](https://getcomposer.org/download/) unde se foloseste si PhP-ul:
 ...
 - [YT@EscoTech: STT in PhP ~ Use Open-AI to Convert Speech Into Text with PHP](https://www.youtube.com/watch?v=bE5wWMefo-Y&ab_channel=EscoTech)
 - [GH@livekit: LiveKit-agents ~ A powerful python-framework for building realtime voice-AI-agents](https://github.com/livekit/agents)
