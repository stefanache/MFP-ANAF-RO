...
Transmiterea unei ***eFacturi*** **UBL/CII** ***xml*** **valida** si **semnata digital** poate fi transmisa in **SPV**-ul **ANAF**-ului folosind un [***cod de transmitere si incarcare/"upload"***](https://iapp.ro/articol/incarca-factura-xml-in-spv-api-anaf-php-oauth2) bazat pe [***cURL***.](https://www.php.net/manual/en/curl.examples-basic.php)
