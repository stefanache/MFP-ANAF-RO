...
Pentru aceste **web-servicii publice** nu este necesar sa aveti drepturi speciale insa pt a putea [**depune**](https://www.anaf.ro/anaf/internet/ANAF/servicii_online/inreg_api) o eFactura(UBL/CII xml) dupa ce a aceasta a fost ***generata,validata si semnata digital*** trebuie sa interactionati cu [api-ul ANAF](https://www.anaf.ro/anaf/internet/ANAF/servicii_online/inreg_api) care necesita totusi un anumit ***context(mediu)*** de **autorizare si acces**;

Pentru interactiunea cu **api-ul ANAF** sunt necesari mai multi [**pasi premergatori**](https://www.anaf.ro/anaf/internet/ANAF/servicii_online/inreg_api)(obtinerea certificatului digital,inregistrarea utilizatorului, aplicatiei-utilizator,[obtinerea token-ului digital OAuth2](https://static.anaf.ro/static/10/Anaf/Informatii_R/API/Oauth_procedura_inregistrare_aplicatii_portal_ANAF.pdf)...) care sunt prevazuti in *documentatia tehnica*(ghiduri,instructiuni,...) [**ANAF**](https://static.anaf.ro/static/10/Anaf/AsistentaContribuabili_r/Ghid_RO_eFactura.pdf) si [**MFP**](https://mfinante.gov.ro/static/10/Mfp/ghidE-FACTURA.pdf)(precum si pe multe alte site-uri mai mult sau mai putin oficiale)

[Transmiterea](https://hotfox.ro/forum/viewtopic.php?t=149) unei ***eFacturi*** **UBL/CII** ***xml*** **valida** si **semnata digital** poate fi transmisa in **SPV**-ul [**ANAF**](https://www.anaf.mfinante.gov.ro/anaf/internet/Iasi/info_iasi/programe/!ut/p/a1/jZDBCoJAEIafxqszq2jSzagUKSpI1L2IxrYK6sq65eun3oLamtsM3wf__EAhBdoVz5oXqhZd0cw7dfOQhG5oeVZ0CnaIF2e_Ca5HgkFkT0CmAQ4rrW87eh-35D8fv4yPv_InQLXI_IEOWCIugCZDBJQ3olz6zPyutD0OVLI7k0yaDzmdK6X6YW2ggeM4mlwI3jDzJloDPymVGBSk7yT0bRynWJ_bxBted0hzEw!!/dl5/d5/L2dBISEvZ0FBIS9nQSEh/)-ului folosind un [***cod de transmitere si incarcare/"upload"***](https://iapp.ro/articol/incarca-factura-xml-in-spv-api-anaf-php-oauth2) bazat pe [***cURL***.](https://www.php.net/manual/en/curl.examples-basic.php);
Pentru a putea insa **transmite facturi** trebuie sa va autorizati mai intai/in prealabil accesul folosind protocolul [**OAUTH2.0**](https://static.anaf.ro/static/10/Anaf/Informatii_R/API/Oauth_procedura_inregistrare_aplicatii_portal_ANAF.pdf) (adica, mai exact, trebuie sa va procurati mai intai un **token** de autorizare a accesului la acest **api** al ***ANAF***-ului)
