...
Aceste date/informatii ar putea fi foarte utile pentru [**generarea automata eFactura UBL/CII ***containerizata*** in format xml**](https://mfinante.gov.ro/static/10/eFactura/prezentare%20apeluri%20API%20E-factura.pdf).
