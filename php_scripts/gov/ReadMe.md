...
Daca aveti nevoie de date complete despre o **firma** sau alta(***radiata*** ori ***neradiata***, ***cu*** sau ***fara*** **sediu**) puteti utiliza setul de date [**ONRC**](https://data.gov.ro/dataset/firme-inregistrate-la-registrul-comertului-pana-la-data-de-07-ianuarie-2024) postat pe portalul data.gov.ro
