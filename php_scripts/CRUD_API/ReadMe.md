...
- si sa permita un access de tip modern <a href="">REST</a> sau REST-like(chiar daca mi-as fi dorit/de preferat ar fi fost sa permita utilizarea limbajului de date [**GraphQL**](https://medium.com/swlh/setting-up-graphql-with-php-9baba3f21501))
