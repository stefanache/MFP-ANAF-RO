...
<br/><hr/>
  ...
  <br/><hr/>
     - <b>PHP 7.2</b> sau o versiune ulterioară cu drivere <i>PDO</i> activate(in **php.ini** trebuie sa aveti **extension=pdo_mysql** de/necomentat) pentru unul dintre aceste sisteme de baze de date(b.d.):<br/>
