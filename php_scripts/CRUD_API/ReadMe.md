...
<br/><hr/>
  ...
  <br/><hr/>
     - <b>PHP 7.2</b> sau o versiune ulterioară(eu am testat pe PHP 8.3.7) cu drivere <i>PDO</i> activate(in <b>php.ini</b> trebuie sa aveti <b>extension=pdo_mysql</b>  de/necomentat) pentru unul dintre aceste sisteme de baze de date(b.d.):<br/>
