...
asa ca in acest [**workshop**](https://github.com/stefanache/MFP-ANAF-RO/tree/main/php_scripts/CRUD_API), am rearanjat acest document complet si complex si am incercat o traducere/parafrazare, arborescent-structurata,  cat mai precisa/succinta, care sper eu o sa permita/ajute la o mai buna intelegere/analiza(sau macar sa constituie o sursa de inspiratie in acest demers).
