...
[**Composer**](https://programam.ro/posts/view/ce-este-composer) va citi fisierul [***composer.json***](https://github.com/stefanache/MFP-ANAF-RO/blob/main/php_scripts/CRUD_API/composer.json) pentru a stii ca anume **dependente(libarii,tools-uri...)** trebuiesc instalate pt acest **PHP-CRUD-API**.
  <hr/><br/>
  </details>  
