...
<br/><hr/>
  ...
  <br/><hr/>
     - <b>PHP 7.2</b> sau o versiune ulterioară cu drivere <i>PDO</i> activate(in <b>php.ini</b> trebuie sa aveti <b>extension=pdo_mysql</b>  de/necomentat) pentru unul dintre aceste sisteme de baze de date(b.d.):<br/>
  ...
  - in final trebuie rulat batch-ul(creat de mine) **_RUN.bat**(consultati si **phpinfo()** din ***index.php***, sa vedeti daca suportul **PDO**,din ***php.ini*** este activat?!).
