...
- se instaleaza(versiunile specifice SO-ului gazduit curent/de testat) si se starteaza <br/>bazele de date(MariaDB/MySQL, PostgreSQL, SQL-Server), cu care se vor efectua testele de functionalitate(aceste baze de date SQL contin datele/tabelele relationale ale unui exmeplu de blog),
