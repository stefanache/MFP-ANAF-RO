...
Asadar, puteți <b>compila</b> toate fișierele necompilate din directoarele <b>src</b> si <b>vendor</b>, într-un singur fișier  "<a href="https://github.com/codemage66/PHP-CRUD-API/blob/main/api.php">api.php</a>"(construind colateral si fiserul librarie-include: <a href="https://github.com/stefanache/MFP-ANAF-RO/blob/main/php_scripts/CRUD_API/api.include.php"><b>api.include.php</b></a>), folosind <a href="https://github.com/stefanache/MFP-ANAF-RO/blob/main/php_scripts/CRUD_API/build.php">buid.php</a>, in comanda urmatoare:
