...
Procesul implementarii(de catre **Developers**) arhitecturii <b>AWS-cloud</b> cu <b>scalabilitate ridicată</b> pt. deservirea *site*-ului/*aplicatiei*(*web*)-(**End/user**)- este simplu:
