...
<br/>*Notă*: trebuie să vă asigurați că includeți și *Redis* în codul dvs.
 ...
 - 9-(**Auto-Scaling group: Master/instance+Slave/instance**)- Creați un *grup* **Auto-Scaling** și *reguli* de **echilibrare**-(**Classic/Load/Balancer**)- a *încărcăturii* pentru infrastructura dvs. ***AWS***.
