...
<br/>*Notă*: trebuie să vă asigurați că <ins>includeți</ins> și *Redis*(creat in pasul ***07.***) în codul dvs.
 ...
 <br/>Această funcție(pas ***09.***: ***AS***+***LB***) va <ins>*crea*</ins> sau va <ins>*distruge*</ins> (*instante*-de-)*servere* <ins>în funcție de</ins> nivelurile-de-cerere(**End/user**) de-pe **aplicație/site**-ul *web*.
