...
Inainte de a discuta despre un proiect e inalta scalabilitate pt PhP, as propune ca si pas premergator de pregatire sa va aruncati o privire asupra acesuit proiect [AWS CI-CD](https://medium.com/@awseng12/ci-cd-pipeline-with-github-aws-code-pipeline-code-deploy-load-balancer-auto-scaling-group-3732a5661dbb).
