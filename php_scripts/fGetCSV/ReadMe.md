...
Mai multe detalii despre geo-spatial.org si despre proiectul date de contact ale primariilor/UAT-urilor din localitati de resedinta puteti sa gasiti in sectiunea [***js_scripts/MFP***](https://github.com/stefanache/MFP-ANAF-RO/tree/main/js_scripts/mfp);
