...
La final as avea o recomandare de a  citi si aceasta procedura [***Oauth 2.0***](https://static.anaf.ro/static/10/Anaf/Informatii_R/API/Oauth_procedura_inregistrare_aplicatii_portal_ANAF.pdf)(mai ales, despre autorizarea accesului la serviciile Web-ANAF, ale API-urilor dezvoltate, de catre diversi dezvoltatori ai Persoanelor-Juridice/PJ, pe baza unui token/jeton-ul [**JWT**](https://www.nexuserp.ro/noutate/implementare-obtinere-tokenuri-de-tip-jwt-pentru-autentificare-cu-protocolul-oauth-in-spv-e-factura-si-e-transport/101230?srsltid=AfmBOooxnkiYdE4uHIT17_dpOtvDQOTBlydx6tAUw8Mx0g0oWrzusrzN)) elaborata de catre [**ANAF**](https://www.anaf.ro/anaf/internet/ANAF/servicii_online/inreg_api)(procedura este valabila pt serviciile web ale ANAF: [**e-Factura**](https://www.licomp.ro/efactura_tutor.aspx), eTransport..).
Pentru **API**-uri scrise in PhP sunt mai multe [***exemple-de-cod**](https://lorand.work/autentificare-oauth-si-obtinere-token-jwt-de-la-anaf-folosind-php/) pe piata in ceea ce priveste procedura ***OAuth*** bazata pe **JWT**. In cazul in care doriti sa lucrari cu WordPress(WP) acest [post](https://ro.wordpress.org/plugins/jwt-authentication-for-wp-rest-api/) va poate fi de ajutor.
