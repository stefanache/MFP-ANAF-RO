...
Pentru **API**-uri scrise in PhP sunt mai multe [***exemple-de-cod**](https://lorand.work/autentificare-oauth-si-obtinere-token-jwt-de-la-anaf-folosind-php/) pe piata in ceea ce priveste procedura ***OAuth*** bazata pe **JWT**
