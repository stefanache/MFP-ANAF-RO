...
La final as avea o recomandare de a  citi si aceasta procedura [***Oauth 2.0***](https://static.anaf.ro/static/10/Anaf/Informatii_R/API/Oauth_procedura_inregistrare_aplicatii_portal_ANAF.pdf)(mai ales despre token/jeton-ul **JWT**) elaborata de catre **ANAF**
