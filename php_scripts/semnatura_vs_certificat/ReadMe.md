...
La final as avea o recomandare de a  citi si aceasta procedura [***Oauth 2.0***](https://static.anaf.ro/static/10/Anaf/Informatii_R/API/Oauth_procedura_inregistrare_aplicatii_portal_ANAF.pdf)(mai ales despre autorizarea accesului la serviciile Web-ANAF ale API-urilor dezvoltate si utilizate de PJ pe baza unui token/jeton-ul **JWT**) elaborata de catre [**ANAF**](https://www.anaf.ro/anaf/internet/ANAF/servicii_online/inreg_api)
