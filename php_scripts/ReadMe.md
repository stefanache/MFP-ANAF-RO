...
Daca aveti nevoie de **cursul BNR** pentru o ***valuta*** anume probabil ca acest **[github-repository**](https://github.com/WPPlugins/curs-valutar-bnr/blob/master/curs_valutar_bnr.php) va poate fi de ajutor;
