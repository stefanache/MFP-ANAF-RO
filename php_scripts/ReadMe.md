...
***Nota*** Am extras cateva scripturi php de pe blog-ul [***iapp.ro***](https://iapp.ro/blog) in subdirectorul [**iapp**](https://github.com/stefanache/MFP-ANAF-RO/tree/main/php_scripts/iapp)
