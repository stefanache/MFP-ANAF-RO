...
***[Nota](https://static.anaf.ro/static/10/Anaf/Declaratii_R/instructiuni/instructiuni2.6.htm)*** :
   ...
   Acest **certificat digital calificat** arata ca detinatorul poate [***semna digital***](https://transsped.ro/certificate?gad_source=1&gclid=CjwKCAjw_LOwBhBFEiwAmSEQAS1ZTy_LDOfprluFv4d-pQ93zpNAohMf6RqK9QSI4lMFs1HMneZYyRoCPHwQAvD_BwE) anumite documente oficiale.
