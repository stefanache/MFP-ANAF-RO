...
Daca XML-ul se ocupa de containerizarea arborescenta DOM(Document Object Model), **UBL**-ul se ocupa de reguli de scriere(sintactice), de regulile ontologice(existentiale) ale obiectelor/entitatilor
