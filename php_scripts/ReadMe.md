...
Pentru cei care doresc sa-si construiasca propriul generator ***UBL2.1/xml eFactura*** programatic utilizand limbajul **PhP** probabil ca ar fi util ca in prealabil sa aruncati o privire catre depozitul [***danielgp/eFactura***](https://github.com/danielgp/eFactura/tree/main)
