...
Daca ***XML***-ul se ocupa de containerizarea arborescenta DOM(Document Object Model), **UBL**-ul se ocupa de /[re]prezinta reguli de scriere(sintactice), de regulile ontologice(existentiale) ale obiectelor/entitatilor
