...
**Google** are si el un producator/creator de facturi([Invoicer](https://chromewebstore.google.com/detail/produc%C4%83tor-de-facturi-pen/nhppolcapbkijdpakbapijalcgnfjbgb?hl=ro)); Am descoperit asta folosind motorul de cautare [ChromeWeb a.k. Grepper](https://chromewebstore.google.com/search/e-Factura?hl=ro) al [Google](https://chromewebstore.google.com/search/e-Factura?hl=ro);
