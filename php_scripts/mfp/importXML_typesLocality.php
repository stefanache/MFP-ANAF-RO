...
<html lang="en">
  ...
  <body>
<?php
	//	http://localhost/MFP/importXML_typesLocality.php

	$debug=false;

	// get xml from url
	//$url = 'https://localhost/MFP/downloads/nomTipLocalitati.xml';
	$url="https://mfinante.gov.ro/static/40/Mfp/nomenclatoare/nomTipLocalitati.xml";
	...
	foreach ($xml->rand as $randElement) {
		...
		// start sql statement
		$sql_insert = "INSERT INTO ".$table_name."(pk_tiploc, COD, DENUMIRE )
