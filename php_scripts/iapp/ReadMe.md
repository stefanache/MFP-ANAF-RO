...
[**InsideApp.ro**](https://iapp.ro/articol/exemplu-de-integrare-api-anaf-spv-php-oauth2) are aceasta pagina extrem de compacta/concisa si extrem de productiva/competitiva care acopera intreg fluxul de comunicare cu ANAF in ceea ce priveste ***e-Factura***, exceptand desigur zona de pre-procesare(editare XML,verificare/validare) si post-procesare(transformare XML in PDF,...):
