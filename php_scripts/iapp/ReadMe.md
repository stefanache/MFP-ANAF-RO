...
**Nota:** 
 ...
 - Legat de **ANAF**(si, daca vreti... de subiiectul [***e-Factura***](https://github.com/topics/e-factura?l=php)) puteti consulta [**repos**](https://github.com/topics/anaf?l=php)-uri **github** scrise in **PhP**
