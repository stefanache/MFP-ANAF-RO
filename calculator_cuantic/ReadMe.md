[Salutare](https://chatgpt.com/share/67bee958-3e5c-800b-8c28-baa1e8dac211)
 ...
 - [WL: Principiul de incertitudine Heisenberg](https://en.wikipedia.org/wiki/Uncertainty_principle)
   <br/>Acesta afirmă că există o limită a preciziei cu care anumite perechi de proprietăți fizice, cum ar fi poziția și impulsul , pot fi cunoscute simultan.
   ...
   <a href="https://en.wikipedia.org/wiki/Uncertainty_principle"> <img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/dfad4605bd5cc074dba10330bd766f60b113fa1b"></img></a>    unde    <img src="https://wikimedia.org/api/rest_v1/media/math/render/svg/df05180652a87fe1af83af4bba3402117bd18466"></img>    este *contanta Planck redusa* iar σ este *abaterea standard* a pozitiei(σ<sub>x) si respectiv a impulsului(σ<sub>p</sub>). 
   
   Astfel de variabile pereche sunt cunoscute ca *variabile complementare* sau *variabile conjugate canonic*.
