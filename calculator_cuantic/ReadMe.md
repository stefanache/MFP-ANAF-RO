...
O sa postez aici un cocktail (citit cocteil, a.k.a amestec) de articole legate de fenomenul [**cuantic**](https://www.youtube.com/results?search_query=Olivia+Lanes+Quantum+Questions+Answered%3A)(lectura placuta!:):
 ...
 - [physics.stackexchange: superpozitia undelor luminoase de diferite culori](https://physics.stackexchange.com/questions/464100/superposition-of-light-waves-of-different-colors); [pubmed.ncbi.nlm.nih.gov: Color superposition: a new modality for contrast echocardiography](https://pubmed.ncbi.nlm.nih.gov/3681012/)
 ...
 - [MS-learn: T gates and T factories](https://learn.microsoft.com/en-us/azure/quantum/concepts-tfactories)
 - [instructables: Algoritm cuantic pentru rezolvarea sistemului de ecuații liniare și inegalități](https://www.instructables.com/Quantum-Algorithm-to-Solve-System-of-Equations-and/); [wiki: Logica-cuantica](https://ro.wikipedia.org/wiki/Logic%C4%83_cuantic%C4%83)
 ...
 - [hpi-courses: Lecture 3 - Bonus Episode - Maxcut with Qiskit](https://open.hpi.de/courses/qc-optimization2023/items/4nHh8DONhXSC5hROoZ1tRD); [vectori si matrici in QC](https://learn.microsoft.com/en-us/azure/quantum/concepts-vectors-and-matrices); [wiki-Tensor](https://ro.wikipedia.org/wiki/Tensor)
 - [MS-learnazure-quantum: Quantum Intermediate Representation](https://learn.microsoft.com/en-us/azure/quantum/concepts-qir)
 ...
 - [quantumcomputinguk.org-tutorials: Rezolvarea problemei k-SAT cu Qiskit](https://quantumcomputinguk.org/tutorials/solving-k-sat-problems-with-qiskit)
...
<br/>Pe lângă cadrul de experiment în sine, Qiskit Experiments are și o bibliotecă bogată de experimente pentru calibrarea și caracterizarea qubiților.
 ...
 - [RomaniaLibera.ro: Entanglementul(intricarea) cuantic(a), soluția pentru a avea procesoare super-rapide](https://romanialibera.ro/special/video-entanglementul-cuantic-solutia-pentru-a-avea-procesoare-super-rapide-366106/)
 ...
 - [WK: QE/EPR](https://en.wikipedia.org/wiki/Quantum_entanglement); [WK: Paradoxul **EPR**(Einstein, Podolsky și Rosen)](https://ro.wikipedia.org/wiki/Paradoxul_EPR); [WK: EPR-paradox](https://en.wikipedia.org/wiki/Einstein%E2%80%93Podolsky%E2%80%93Rosen_paradox)(stari incurcate/intricate/entaglate)
 ...
 - [wiki: *Decoerenta cuantica*](https://ro.wikipedia.org/wiki/Decoeren%C8%9B%C4%83_cuantic%C4%83); [wiki: spatiul Hilbert](https://ro.wikipedia.org/wiki/Spa%C8%9Biu_Hilbert)
   ...
   <br/>Natura cuantică a sistemului pur și simplu "se scurge"(cu referire la continuitatea in timp) în mediul din jur.
...
- [Google Quantum AI: Faceți cunoștință cu Willow, cipul Google cuantic de ultimă generație](https://nocash.ro/meet-willow-our-state-of-the-art-quantum-chip/)  
 ...
 - [WK: Hamiltonianul( operatorul corespunzător energiei totale a sistemului.) Q-mecanic](https://ro.wikipedia.org/wiki/Hamiltonian_(mecanic%C4%83_cuantic%C4%83))
 ...
 - [telework.ro-categ-fizica-stiinta: Mecanica cuantica](https://www.telework.ro/ro/category/ro/stiinta/fizica-stiinta/mecanica-cuantica/)
 ...
 - [unap.ro-cssas-PDF_studii: Impactul noilor tehnologii asupra artei militare](https://cssas.unap.ro/ro/pdf_studii/impactul_noilor_tehnologii_asupra_artei_militare.pdf)
