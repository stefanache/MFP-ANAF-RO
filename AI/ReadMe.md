...
Aici voi plasa tutoriale,ghiduri... pentru efectuarea unor sarcini/task-uri/activitati economice,drept,medical(si nu numai...) folosind AI([domain-specific-LLMs](https://medium.com/sage-ai/building-domain-specific-llms-for-reliable-accounting-solutions-at-sage-f5f49479c8ad), Mecanismul atentiei in transformatoare,...):
 ...
 - [Jerry-Liu:  “document MCP server” for AI-agents](https://www.linkedin.com/posts/jerry-liu-64390071_ive-been-thinking-about-this-idea-of-a-activity-7326034385671983104-KU7l?utm_source=share&utm_medium=member_desktop&rcm=ACoAABLIPGMB6KpJrQjF9LX4I4WFQuRY84ckvhg)
   ...
   <b>Agenții</b> pot(decide si orchestra sau actiona) apela <b><i>instrumente</i></b> și pot(decide si actiona) <b><i>recupera</i></b> <i>date</i>(în sens general!).
...
<br/>[KA-Attention](https://www.aimodels.fyi/papers/arxiv/kolmogorov-arnold-attention-is-learnable-attention-better) - avantaje:
 ...
 - [Cotype - OL search query](https://ollama.com/search?q=Cotype)
 - [RG: Learning to Love LLMs for Answer Interpretation: Chain-of-Thought Prompting and the AMMORE Dataset](https://www.researchgate.net/publication/390110124_Learning_to_Love_LLMs_for_Answer_Interpretation_Chain-of-Thought_Prompting_and_the_AMMORE_Dataset)
 - [stackoverflow: What is the right way to do system prompting with Ollama in Langchain using Python?](https://stackoverflow.com/questions/77550506/what-is-the-right-way-to-do-system-prompting-with-ollama-in-langchain-using-pyth)
 - [programmer-post-functions: Beyond Text Generation: Coding Ollama Function Calls and Tools](https://programmer.ie/post/functions/)
 - [ollama-mannix: OL-python for LLM=qwen2-7b](https://ollama.com/mannix/qwen2-7b)
 ...
 - [medium@the-AI-forum: Building an Advanced RAG Pipeline Using Docling, Groq, Ollama with GLIDER Evaluation](https://medium.com/the-ai-forum/building-an-advanced-rag-pipeline-using-docling-groq-ollama-with-glider-evaluation-b91c290b0c84)
 - [weaviate-blog: Local-RAG with Ollama si Weaviate](https://weaviate.io/blog/local-rag-with-ollama-and-weaviate)
 - [runzhe-yang.science: The Socratic Method for Self-Discovery in Large Language Models](https://runzhe-yang.science/2023-05-05-socratic/)
 - [<b>Server MCP Romania</b>(ONRC,ANAF,MJ)](https://www-incorpo-ro.translate.goog/en-us/tools/mcp-romania/?_x_tr_sl=auto&_x_tr_tl=ro&_x_tr_hl=ro)
 - [<b>Edu.Romania MCP Online</b>](https://aiparte.ro/scoli/server_scoli/)
 - [<b>AI Romanaia MCP-server</b>](https://ai-romania.ro/cum-sa-programezi-un-server-mcp/)
 - [<b>TSM.ro - MCP</b>](https://www.todaysoftmag.ro/article/4449/protocolul-mcp-si-modul-in-care-ne-influenteaza-viata)
 ...
 - [<b>wiki.ro - MCP server</b>](https://aiparte.ro/rowiki/)
