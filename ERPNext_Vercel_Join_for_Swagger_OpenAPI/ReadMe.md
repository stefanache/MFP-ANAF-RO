...
Please consult this [**tutorial**](https://dev.to/tobidelly/step-by-step-guide-to-deploying-a-project-to-vercel-using-github-actions-for-free-l61) about [***Vercel***](https://vercel.com/docs/getting-started-with-vercel) for more [details](https://vercel.com/docs/frameworks/backend/fastapi).
