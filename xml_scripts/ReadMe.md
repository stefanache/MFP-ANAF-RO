...
Un validator pentru reguli furnizate in format <b>schematron<b>(<i>dar nu numai!</b>) este si acest HTTP micro-service [<b>ion-docval</b>](https://ion-docval.ionite.net/about/introduction/)(desi nu l-am testat cred ca merita testat!!!)
