...
Un astel de [motor java de validare](https://github.com/phax/phive) cum este [phive](https://github.com/phax/phive-rules/tree/master) utilizeaza seturile de reguli nationale printre care si CIUS-RO.
