...
Am apelat la un spatiu de dimensiune 3 (3D, deci cu 3 grade de libertate) pt ca este mai intuitiv dar daca va ganditi la mecanismele/articulatiile fizice/mecanice veti afla ca aceste grade de libertate pot fi mai multe de 3 si astfel putem vorbi(fireste extrapoland) de dimensiuni **n** mai mari.
