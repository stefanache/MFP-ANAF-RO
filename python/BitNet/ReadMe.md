...
<hr/>
    ...
    2^<b>1.58b</b>iti = aproximativ/~ 3 biti);
        Mai succint, când reprezentăm un sistem cu 3 valori în binar, numărul de biți de care avem nevoie este <b>(log 3) / (log 2) = 1,58</b>.
