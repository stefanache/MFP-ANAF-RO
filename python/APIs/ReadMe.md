...
în timp ce o aplicație(aplicație) este un program software conceput pentru o sarcină specifică, adesea utilizat de un utilizator pe un computer sau dispozitiv
