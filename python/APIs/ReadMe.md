...
<br/>Aceasta(**API**) permite dezvoltatorilor să <ins>utilizeze(apeleze)</ins> *funcționalități* furnizate de un alt *serviciu* fără a fi nevoie să înțeleagă detaliile complexe ale modului în care este implementat serviciul/din spatele acestuia(serviciului).
