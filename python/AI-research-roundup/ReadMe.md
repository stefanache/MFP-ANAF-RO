...
Pentru inceput, pentru a intelege cu usurinta, acest articol/săptămânal, vom trece in revistă, cativa dintre acesti termeni:
 ...
 - [**FT**](https://en.wikipedia.org/wiki/Fine-tuning_(deep_learning)) = Fine-Tuning = reglare/Tunare-Fina.
   ...
   <br/>*Reglarea-fină*(**FT**) se poate face pe <u>întreaga</u> *rețea-neuronală*(**NN**), sau doar pe un *<u>subset-de-straturi</u>* ale *acesteia*(**NN**), caz în care, *straturile*, care *nu sunt reglate-fin*(**FT**), sunt „*înghețate*”(adică, *nu sunt modificate* în timpul *retro-propagarii*).
