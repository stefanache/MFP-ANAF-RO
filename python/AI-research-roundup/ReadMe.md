...
Mai departe, scalarea **s1-32B** *<ins>cu</ins> forțarea bugetului*, permite extrapolarea performanțelor sale, depășindu-le pe cele ale modelului standard/obisnut, adica cel *<ins>fără</ins> interventie*, in/pe timpul/durata-de-testare: de la **50%**la **57%** pe/pt sarcina **AIME24**.

*Modelul*, *datele* și *codul* sunt <ins>open-source</ins> la adresa: [*https://github.com/simplescaling/s1*.](https://github.com/simplescaling/s1)
