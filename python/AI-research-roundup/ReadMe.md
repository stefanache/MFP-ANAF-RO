...
Pentru inceput, pentru a intelege cu usurinta, acest articol/săptămânal, vom trece in revistă, cativa dintre acesti termeni:
 ...
 - [**SFT**](https://huggingface.co/docs/trl/sft_trainer) = Supervised Fine-Tuning = reglare-Fină Supravegheată.
   <br/>*Tunarea/Reglajul fin supravegheat*(**S*FT***) este utilizat, în mod obișnuit, pt antrenarea modelelor de limbaj(**LLM**), in a <ins>imita/cauta si reda</ins> *răspunsurile*-*adnotate*(etichetate), la instrucțiunile/regulile/cerintele/task-urile date/incredintate/cerute.
