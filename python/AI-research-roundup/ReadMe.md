...
<br/>[*Nota*](https://developers.cloudflare.com/workers-ai/fine-tunes/loras/:
<br/>Low-Rank Adaptation ↗ (LoRA) este o metodă specifică de reglare fină care poate fi aplicată la diferite arhitecturi de model, nu doar LLM. Este obișnuit ca greutățile modelului pre-antrenate să fie direct modificate sau îmbinate cu greutăți suplimentare de reglare fină în metodele tradiționale de reglare fină. LoRA, pe de altă parte, permite ca greutățile de reglare fină și modelul pre-antrenat să rămână separate, iar modelul pre-antrenat să rămână neschimbat.
<br/>Rezultatul final este că puteți antrena modele pentru a fi mai precise la anumite sarcini, cum ar fi generarea de cod, a avea o anumită personalitate sau generarea de imagini într-un anumit stil.
