...
Pentru inceput, pentru a intelege cu usurinta, acest articol/săptămânal, vom trece in revistă, cativa dintre acesti termeni:
 ...
 - [**SFT**](https://huggingface.co/docs/trl/sft_trainer) = Supervised Fine-Tuning = reglare-Fină Supravegheată.
   <br/>*Tunarea/Reglajul fin supravegheat*(**S*FT***) este utilizat, în mod obișnuit, pt antrenarea modelelor de limbaj(**LLM**), in a <ins>imita</ins> *răspunsurile*-*adnotate*(etichetate), la instrucțiunile/regulile/cerintele/task-urile date/incredintate/cerute.
 - [**CFT**](https://arxiv.org/pdf/2501.17703?) = Critique Fine-Tuning = reglare-Fină Critică.
   <br/>*Tunarea/Reglarea-Fina Critică*(**C*FT***), este o strategie, în care modelele(**LLM**), învață să *critice*, răspunsurile zgomotoase(care d.p.d.v al sarcinii, sunt...partial>**100%** sau total=**100%** gresite=adica raspunsurile care au/poseda un grad=procent **%** de **incorectitdine**), mai degrabă... decât sa le *imite*... pe cele corecte(total=100% corecte = 0% incorecte).
