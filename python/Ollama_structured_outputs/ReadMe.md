...
Am folosit server-ul de LLM-uri, ***Ollama***,  unde am incarcat(*pull*) cele 3 modele necesare acestui [proiect](https://github.com/stefanache/MFP-ANAF-RO/blob/main/python/Ollama_structured_outputs/app.py):
                              ...
                              C:\Users\user>
Modelele **llama3.1** si [**llama3.2**](https://www.fahdmirza.com/2024/11/create-free-local-ai-dungeon-game-with.html) sunt modele conversationale, in timp ce **llama3.2-vision** este un model pt Computer-Vision.(a se revedea [exemplele](https://www.youtube.com/@fahdmirza) postate de catre [**Fahd-Mirza**](https://www.fahdmirza.com/), care utilizeaza astfel de LLM-uri).
