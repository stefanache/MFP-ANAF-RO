...
***Iată câteva limitări ale Reflexiei:***
 ...
 - **Limitări de generare de cod** : Există limitări pentru dezvoltarea bazată pe *test/incercare* în specificarea *mapărilor*(*asocierilor*|*corespondentelor*) precise de *intrare-ieșire* (de exemplu, *funcție de generator nedeterministă* și *ieșiri ale funcției influențate de hardware*).
