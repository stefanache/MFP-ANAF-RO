...
***Iată câteva limitări ale Reflexiei:***
 ...
 - **Limitări de generare de cod** : Există limitări pentru dezvoltarea bazată pe test în specificarea mapărilor(asocierilor) precise de intrare-ieșire (de exemplu, funcție de generator nedeterministă și ieșiri ale funcției influențate de hardware).
