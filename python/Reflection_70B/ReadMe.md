...
***Nota***: In cazul exemplului [AirLLM](https://huggingface.co/blog/lyogavin/airllm), pentru utilizatorii(**<USER_LOGIN>**) de **windows**, care au ***deja descarcat*** modelul(in prealabil), pentru a-l utiliza pe cel(modelul local deja descarcat: **<Model_ID>**) ***local***, va trebui sa foloseasca instructiunea:

          model = AirLLMLlama2("C:\Users\<USER_LOGIN>\.cache\huggingface\hub\models--garage-bAInd--Platypus2-70B-instruct\snapshots\<Model_ID>")
