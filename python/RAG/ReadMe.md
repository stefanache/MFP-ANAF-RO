...
- [LNKDN-pulse: Building *Agentic*-AI ~ A Practical Guide with LangChain(LC=logica+memoria), MCP=guvernanta+scalabilitate, **RAG**(informare cu cunostinte solide) & Ollama(OL=server-LLM=implementarea personalizabilă, axată pe nivel local)](https://www.linkedin.com/pulse/building-agentic-ai-practical-guide-langchain-mcp-rag-ollama-6v8kf/)
