...
In legatura cu subiectul HuggingFace(HF) o sa plasez aici cateva link-uri utile:
 ...
 - [YT: libraria **vLLM**](https://www.youtube.com/watch?v=tLEdDMeCe5U&ab_channel=FahdMirza)
   ...
   <br/>Utilizarea [LoRA](https://docs.vllm.ai/en/stable/features/lora.html) pentru a adapta modelele pre-antrenate pentru sarcini specifice este o tehnica ideală pentru mediile cu resurse limitate.
