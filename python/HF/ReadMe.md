...
In legatura cu subiectul HuggingFace(HF) o sa plasez aici cateva link-uri utile:
 ...
 - [YT: libraria **vLLM**](https://www.youtube.com/watch?v=tLEdDMeCe5U&ab_channel=FahdMirza)
   ...
   <br/> despre modelele de tip [***LoRA***](https://docs.vllm.ai/en/latest/features/lora.html) si despre utilizarea acestora cu ajutorul ***ConfyUI***, puteti afa cate ceva din acest [tutorial](https://www.unite.ai/ro/how-to-train-and-use-hunyuan-video-lora-models/);
