...
[**Ollama**](https://weaviate.io/developers/weaviate/modules/reader-generator-modules/generative-ollama) poate rula [loal](https://www.kdnuggets.com/ollama-tutorial-running-llms-locally-made-super-simple)nu numai pe PC-uri sau laptop-uri ci chair si pe mini-computere cum ar fi [**Raspberry**](https://www.kevsrobots.com/blog/ollama)
