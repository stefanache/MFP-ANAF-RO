...
<br/>Acest test poate fi rulat prin executia batch-ului [**_Test.bat**](https://github.com/stefanache/MFP-ANAF-RO/blob/main/python/chainer-doc2vec/_Test.bat) si face o regasire dupa similaritate.
