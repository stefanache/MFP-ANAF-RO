...
Pentru textul de intrare/intrebare("An American in Paris") stocat in fisierul [**query.txt**](https://github.com/stefanache/MFP-ANAF-RO/blob/main/python/chainer-doc2vec/input.txt) ar trebui sa obtineti urmatorul... 
