...
O incercare similara(**train_doc2vec.py**,**train_word2vec.py**) poate fi descarcata/gasita [d]in acest depozit-github [***dkaterenchuk***/**py_anything2vec**](https://github.com/dkaterenchuk/py_anything2vec)
