...
[**NGROK-Agent**](https://ngrok.com/docs/agent/) este un program ușor de utilizat în linie de comandă, 
<br/>care redirecționează traficul:

 - de la endpoint-urile pe care le creează(pe/la marginea NGROK)
