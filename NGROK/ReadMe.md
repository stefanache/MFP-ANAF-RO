...
Dupa cum bine stiti, [Stable-Diffusion(**SD**)](https://en.wikipedia.org/wiki/Stable_Diffusion) este un instrument AI-generative care va permite sa creati imagini folosind descrieri textuale simple(**txt2img**).
