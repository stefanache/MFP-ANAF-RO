...
Pentru programatorii in python, NGROK a creat un [python-SDK](https://ngrok.com/blog-post/ngrok-python) care va permite sa integrati NGROK in proiectele dvs.
