...
Daca aveti la dispozitie un server **Ollama** si doriti sa utilizati ca limbaje de programare, combinatia **python**(pt. server) si **scala**(pt. client-UI), de sub ***Ubuntu***, poate nu ar fi o idee rea sa incercati acest [*post*](https://www.fahdmirza.com/2024/08/install-rag-me-up-with-ollama-locally.html), pentru a testa **Rag Me Up**.
