**Seturi de Date deschide(Open-DS) legate de institutiile-guvernamentale ANCPI si INS** - *Ierarhii de date si de raportare-frecventa institutionala* - Forme de prezentare(API,SparQL,Files,...)
