...
O sa postez aici cateva link-uri utile legat de VPN(client-server):
 ...
 - [MS-learn on WS(remote access)-PowerShell(PS): Get-started install RAS-as-VPN?<br/>(Install Remote Access as a VPN server)](https://learn.microsoft.com/en-us/windows-server/remote/remote-access/get-started-install-ras-as-vpn?tabs=powershell)
