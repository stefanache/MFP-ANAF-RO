...
O sa postez aici cateva link-uri utile legat de VPN(client-server):
 ...
 - [pureInfoTech: Setup VPN-server on your W10(or WS-2019) - DDNS  si Router/Port-Forwarding 2(to) incomming(via internet using protocol=PPTP) in your VPN-server](https://pureinfotech.com/setup-vpn-server-windows-10/)
