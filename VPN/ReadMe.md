...
O sa postez aici cateva link-uri utile, legat de VPN(cazul-clasic/standard/uzual...dar nu numai!: client=CLI conectat la un server=SRV/gateway=GW via [VPN-tunel](https://www.tp-link.com/ro/support/faq/2137/)), avand la dispozitie cel putin un PC/VM cu Windows-preInstalat(si poate inca un PC/VM ori mai multe... precum si/sau alte [dispozitive](https://www.a2t.ro/blog/cum-se-configureaz-ddns-pe-un-router-wireless.html): cum ar fi [Router](https://www.tp-link.com/ro/support/faq/297/), NAS...):
 ...
 - [MS_learn-Q&A: Routing & Remote-Access(RRAS) Windows(W10 or W11)](https://learn.microsoft.com/en-us/answers/questions/2028084/routing-remote-access-windows-10-or-11)
 ...
 - [MS-learn-Azure-VPN_GW-VPN_GW-how3_onDevice_tunnel: Configure an **Always-On-VPN**(AOVPN) device tunnel](https://learn.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-howto-always-on-device-tunnel)
 ...
 - [openVPN-AS_docs/system_req: Access-Server(AS) - System Requirement](https://openvpn.net/as-docs/system-requirements.html#docker-requirements)
