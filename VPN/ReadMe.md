...
O sa postez aici cateva link-uri utile legat de VPN:
 ...
 - [blogMan.ro: Creare conexiune (client)VPN in Windows. Care sunt avantajele! (necesita un VPN-server pre-creat pe un Router sau pe un NAS)](https://blogman.ro/tutorial-conexiune-vpn-windows-netflix-avantaje/)
